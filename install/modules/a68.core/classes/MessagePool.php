...
interface A68_IMessagePoolStatic
{
...
class A68_CMessagePool implements A68_IMessagePool
{
...
class A68_CMessagePoolDecorator implements A68_IMessagePool {
	...
	public function getMessagePool() {
		if($this->MessagePool == null) {
			$this->MessagePool = new A68_CMessagePool;
		}
