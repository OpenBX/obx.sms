...
class a68_core extends CModule
{
	var $MODULE_ID = "a68.core";
	var $MODULE_VERSION;
	...
	public function a68_core() {
		...
		$this->MODULE_NAME = GetMessage("A68_MODULE_INSTALL_NAME");
		$this->MODULE_DESCRIPTION = GetMessage("A68_MODULE_INSTALL_DESCRIPTION");
		$this->PARTNER_NAME = GetMessage("A68_PARTNER_NAME");
		$this->PARTNER_URI = GetMessage("A68_PARTNER_URI");
	}
