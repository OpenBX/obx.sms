...
$MESS['OBX_SMS_SETT_RESTORE_DEF_CONFIRM'] = 'Вы уверены что хотите очистить настройки всех провайдеров';
$MESS['OBX_SMS_OPTIONS_PROV_HOMEPAGE'] = 'Официальная страница провейдера СМС';
//$MESS[''] = '';
//$MESS[''] = '';
//$MESS[''] = '';
//$MESS[''] = '';
